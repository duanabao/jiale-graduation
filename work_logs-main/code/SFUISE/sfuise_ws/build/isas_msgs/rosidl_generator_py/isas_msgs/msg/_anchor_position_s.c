...
bool isas_msgs__msg__anchor_position__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("isas_msgs.msg._anchor_position.AnchorPosition", full_classname_dest, 45) == 0);
  }
  isas_msgs__msg__AnchorPosition * ros_message = _ros_message;
  {  // id
...
{
  /* NOTE(esteve): Call constructor of AnchorPosition */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("isas_msgs.msg._anchor_position");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "AnchorPosition");
