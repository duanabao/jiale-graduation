...
static const _RTLSRange_type_support_symbol_names_t _RTLSRange_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, isas_msgs, msg, RTLSRange)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, isas_msgs, msg, RTLSRange)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, isas_msgs, msg, RTLSRange)() {
  return &::isas_msgs::msg::rosidl_typesupport_c::RTLSRange_message_type_support_handle;
}
