...
#include "cf_msgs/msg/detail/accel__rosidl_typesupport_fastrtps_c.h"
...
using _Accel__ros_msg_type = cf_msgs__msg__Accel;
...
size_t get_serialized_size_cf_msgs__msg__Accel(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Accel__ros_msg_type * ros_message = static_cast<const _Accel__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Accel__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_cf_msgs__msg__Accel(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cf_msgs
size_t max_serialized_size_cf_msgs__msg__Accel(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cf_msgs__msg__Accel;
    is_plain =
      (
      offsetof(DataType, z) +
      last_member_size
...
static size_t _Accel__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_cf_msgs__msg__Accel(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cf_msgs, msg, Accel)() {
