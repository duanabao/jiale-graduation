...
static const _Tdoa_type_support_symbol_names_t _Tdoa_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cf_msgs, msg, Tdoa)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cf_msgs, msg, Tdoa)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, cf_msgs, msg, Tdoa)() {
  return &::cf_msgs::msg::rosidl_typesupport_c::Tdoa_message_type_support_handle;
}
