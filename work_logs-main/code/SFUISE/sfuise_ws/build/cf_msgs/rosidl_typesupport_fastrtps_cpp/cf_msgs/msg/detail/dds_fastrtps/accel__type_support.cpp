...
#include "cf_msgs/msg/detail/accel__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const cf_msgs::msg::Accel & ros_message,
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cf_msgs::msg::Accel;
    is_plain =
      (
      offsetof(DataType, z) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const cf_msgs::msg::Accel *>(
    untyped_ros_message);
...
{
  return &cf_msgs::msg::typesupport_fastrtps_cpp::_Accel__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cf_msgs, msg, Accel)() {
  return &cf_msgs::msg::typesupport_fastrtps_cpp::_Accel__handle;
}
