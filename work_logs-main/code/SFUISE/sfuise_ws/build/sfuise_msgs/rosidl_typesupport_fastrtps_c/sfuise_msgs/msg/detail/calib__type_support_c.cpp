...
#include "sfuise_msgs/msg/detail/calib__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/point__functions.h"  // gravity, t_nav_uwb, t_tag_body_set
#include "geometry_msgs/msg/detail/quaternion__functions.h"  // q_nav_uwb
...
using _Calib__ros_msg_type = sfuise_msgs__msg__Calib;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _Calib__ros_msg_type * ros_message = static_cast<const _Calib__ros_msg_type *>(untyped_ros_message);
  // Field name: gravity
  {
  ...
  // Field name: t_nav_uwb
  {
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->t_nav_uwb, cdr))
    {
      return false;
    }
  }

  // Field name: q_nav_uwb
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->q_nav_uwb, cdr))
    {
      return false;
    }
  }

  // Field name: t_tag_body_set
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->t_tag_body_set, cdr))
    {
      return false;
    }
  }
  ...
  void * untyped_ros_message)
{
  ...
  _Calib__ros_msg_type * ros_message = static_cast<_Calib__ros_msg_type *>(untyped_ros_message);
  // Field name: gravity
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _Calib__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_sfuise_msgs__msg__Calib(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sfuise_msgs__msg__Calib;
    is_plain =
      (
...
static size_t _Calib__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_sfuise_msgs__msg__Calib(
...
static message_type_support_callbacks_t __callbacks_Calib = {
  "sfuise_msgs::msg",
  "Calib",
...
static rosidl_message_type_support_t _Calib__type_support = {
