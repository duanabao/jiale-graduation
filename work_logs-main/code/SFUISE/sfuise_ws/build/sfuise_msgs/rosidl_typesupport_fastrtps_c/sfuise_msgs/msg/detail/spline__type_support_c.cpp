...
#include "sfuise_msgs/msg/detail/spline__rosidl_typesupport_fastrtps_c.h"
...
#include "sfuise_msgs/msg/detail/knot__functions.h"  // idles, knots
...
using _Spline__ros_msg_type = sfuise_msgs__msg__Spline;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: knots
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, sfuise_msgs, msg, Knot
      )()->data);
  ...
  // Field name: idles
  {
    ...
    auto array_ptr = ros_message->idles.data;
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      if (!callbacks->cdr_serialize(
          &array_ptr[i], cdr))
  ...
  void * untyped_ros_message)
{
  ...
  _Spline__ros_msg_type * ros_message = static_cast<_Spline__ros_msg_type *>(untyped_ros_message);
  // Field name: start_idx
  {
    cdr >> ros_message->start_idx;
  }
  ...
  // Field name: knots
  {
    ...
    if (ros_message->knots.data) {
      sfuise_msgs__msg__Knot__Sequence__fini(&ros_message->knots);
    }
  ...
  // Field name: idles
  {
    ...
    cdr >> cdrSize;
    size_t size = static_cast<size_t>(cdrSize);
    if (ros_message->idles.data) {
      sfuise_msgs__msg__Knot__Sequence__fini(&ros_message->idles);
    }
    if (!sfuise_msgs__msg__Knot__Sequence__init(&ros_message->idles, size)) {
      fprintf(stderr, "failed to create array for field 'idles'");
      return false;
    }
    auto array_ptr = ros_message->idles.data;
    for (size_t i = 0; i < size; ++i) {
  ...
  size_t current_alignment)
{
  ...
  // field.name knots
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_sfuise_msgs__msg__Knot(
...
static uint32_t _Spline__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_sfuise_msgs__msg__Spline(
  ...
  size_t current_alignment)
{
  ...
  // member: knots
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_sfuise_msgs__msg__Knot(
  ...
  if (is_plain) {
    ...
    using DataType = sfuise_msgs__msg__Spline;
    is_plain =
      (
...
static size_t _Spline__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_sfuise_msgs__msg__Spline(
