...
static const _Knot_type_support_symbol_names_t _Knot_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sfuise_msgs, msg, Knot)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, sfuise_msgs, msg, Knot)),
  }
};
...
{
  return &::sfuise_msgs::msg::rosidl_typesupport_cpp::Knot_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, sfuise_msgs, msg, Knot)() {
  return get_message_type_support_handle<sfuise_msgs::msg::Knot>();
}
