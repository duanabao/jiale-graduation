...
static const _Calib_type_support_symbol_names_t _Calib_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, sfuise_msgs, msg, Calib)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, sfuise_msgs, msg, Calib)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, sfuise_msgs, msg, Calib)() {
  return &::sfuise_msgs::msg::rosidl_typesupport_c::Calib_message_type_support_handle;
}
